		...
		<script type="text/javascript" language="javascript">
            function enviar(){
                ...
                if(form.name.value == ""){
                    ...
                    form.email.focus();
                    return false;
               }else if(form.CodeTextBox.value == ""){
    	...
    	<div id="content">
            ...
            <div id="form">
                ...
                <form name="formulario" method="post"  runat="server" onsubmit="return enviar();">
					...
					<label for="CodeTextBox">Introduce el texto de la imagen: <asp:TextBox ID="CodeTextBox" runat="server" Width="100" MaxLength = "5" ></asp:TextBox> 
                        <asp:Label ID="MessageCorrectLabel" runat="server" Text="Label" Width="100"></asp:Label></label>
