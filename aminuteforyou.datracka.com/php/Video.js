...
//    $.getScript("http://www.aminutetorelax.com/php/testRequest.php", function (data, textStatus, jqxhr){
//        Video.prototype.getVideoUrl(data);
//    });

    var jqxhr = $.ajax( "http://www.aminutetorelax.com/php/testRequest.php" )
